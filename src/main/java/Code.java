...
public class Code {
    ...
    public Code() {
        ...
        // Add dest values to the dest table
        ...
        // Add jump values to the jump table
    ...
    public String dest(String key) {
        return destTable.getOrDefault(key,"");
    }

    public String jump(String key) {
        return jumpTable.getOrDefault(key,"");
    }

    public String comp(String key) {
        return compTable.getOrDefault(key,"");
    }
}
